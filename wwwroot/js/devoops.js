...
function LoadCalendarScript(callback) {
    function LoadFullCalendarScript() {
        if (!$.fn.fullCalendar) {
            $.getScript('/Scripts/fullcalendar/fullcalendar.min.js', callback);
        }
        else {
    ...
    if (!$.fn.moment) {
        $.getScript('/Scripts/moment.min.js', LoadFullCalendarScript);
    }
    else {
...
function LoadTimePickerScript(callback) {
    if (!$.fn.timepicker) {
        $.getScript('/Scripts/jquery-ui-timepicker-addon.min.js', callback);
    }
    else {
        if (callback && typeof (callback) === "function") {
            callback();
...
function LoadBootstrapValidatorScript(callback) {
    if (!$.fn.bootstrapValidator) {
        $.getScript('/Scripts/bootstrapValidator.min.js', callback);
    }
    else {
        if (callback && typeof (callback) === "function") {
            callback();
...
function LoadSelect2Script(callback) {
    if (!$.fn.select2) {
        $.getScript('/Scripts/select2/select2.min.js', callback);
    }
    else {
        if (callback && typeof (callback) === "function") {
            callback();
...
function LoadDataTablesScripts(callback) {
    function LoadDatatables() {
        $.getScript('/Scripts/DataTables/jquery.dataTables.js', function () {
            $.getScript('/Scripts/DataTables/ZeroClipboard.js', function () {
                $.getScript('/Scripts/DataTables/TableTools.js', function () {
                    $.getScript('/Scripts/DataTables/dataTables.bootstrap.js', callback);
                });
            });
        });
    }
...
function LoadFineUploader(callback) {
    if (!$.fn.fineuploader) {
        $.getScript('/Content/fineuploader/jquery.fineuploader-5.0.5.min.js', callback);
    }
    else {
        if (callback && typeof (callback) === "function") {
            callback();
...
function LoadXChartScript(callback) {
    function LoadXChart() {
        $.getScript('/Scripts/xcharts.min.js', callback);
    }
    function LoadD3Script() {
        if (!$.fn.d3) {
            $.getScript('/Scripts/d3/d3.v3.min.js', LoadXChart)
        }
        else {
            LoadXChart();
        }
...
function LoadFlotScripts(callback) {
    function LoadFlotScript() {
        $.getScript('/Scripts/flot/jquery.flot.min.js', LoadFlotResizeScript);
    }
    function LoadFlotResizeScript() {
        $.getScript('/Scripts/flot/jquery.flot.resize.min.js', LoadFlotTimeScript);
    }
    function LoadFlotTimeScript() {
        $.getScript('/Scripts/flot/jquery.flot.time.min.js', callback);
    }
    if (!$.fn.flot) {
        LoadFlotScript();
    }
...
function LoadMorrisScripts(callback) {
    function LoadMorrisScript() {
        if (!$.fn.Morris) {
            $.getScript('/Scripts/morris/morris.min.js', callback);
        }
        else {
            if (callback && typeof (callback) === "function") {
                callback();
    ...
    if (!$.fn.raphael) {
        $.getScript('/Scripts/raphael-min.js', LoadMorrisScript);
    }
    else {
        LoadMorrisScript();
    }
...
function LoadFancyboxScript(callback) {
    if (!$.fn.fancybox) {
        $.getScript('/Scripts/jquery.fancybox.js', callback);
    }
    else {
        if (callback && typeof (callback) === "function") {
            callback();
...
function LoadSparkLineScript(callback) {
    if (!$.fn.sparkline) {
        $.getScript('/Scripts/sparkline/jquery.sparkline.min.js', callback);
    }
    else {
        if (callback && typeof (callback) === "function") {
            callback();
